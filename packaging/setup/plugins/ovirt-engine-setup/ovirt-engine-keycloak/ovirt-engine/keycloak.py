...
class Plugin(plugin.PluginBase):
        ...
        self.environment[otopicons.CoreEnv.MAIN_TRANSACTION].append(
            filetransaction.FileTransaction(
                ...
                content=(
                    ...
                    trust_store=oenginecons.FileLocations.OVIRT_ENGINE_PKI_APACHE_STORE,
                ),
    ...
    def _build_endpoint_url(self, endpoint):
        return 'https://{fqdn}/{keycloak_web_context}/realms/{realm}/protocol/openid-connect/{endpoint}'.format(
